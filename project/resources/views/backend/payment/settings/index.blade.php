                    ...
                    <div class="card m-b-0">
                        <div class="card-header">
                            <div class="card-title full-width">
                                <h5 class="no-margin">Payment Settings
                                    <a href="{{ route('payment.settings.create') }}" class="btn btn-info pull-right m-r-5">Create
                                        Payment Method</a>
                                </h5>
                            </div>
                        </div>
                            ...
                            <table class="table table-hover table-responsive-block dataTable with-export custom-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $row->user->name }}</td>
                                        <td>
                                            <a href="{{ route('payment.settings.edit', [$row->uuid]) }}"
                                            ...
                                            <form action="{{ route('payment.settings.change.status', [$row->uuid]) }}"
