    ...
    <form id="payment-setup-form" role="form" method="POST" action="{{ route('subscription.store') }}">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-6 col-xlg-6">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group required form-group-default input-group @error('client') has-error @enderror">
                            <div class=" form-input-group">
                            <label>Client</label>
            ...
            <div class="row">
                <div class="col-6">
                    <div class="form-group required form-group-default @error('reference_date') has-error @enderror">
                        ...
                        <div class="controls">
                            <input type="text" class="form-control datepicker @error('reference_date') error @enderror"
                    ...
                    <div class="form-group required form-group-default @error('no_of_payments') has-error @enderror">
                        ...
                        <div class="controls">
                            <input type="number" class="form-control @error('no_of_payments') error @enderror"
                                name="no_of_payments" placeholder="No of  Payment" value="{{ old('no_of_payments')}}"
                                autocomplete="off">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <button class="btn btn-complete m-t-15 payment-create" type="submit">CREATE SUBSCRIPTION</button>
