                                    ...
                                    @if ($data != null)
                                        ...
                                        <tr>
                                            ...
                                            <td class="list-item">
                                                ...
                                                @if ($row->is_active == 0)
                                                    <button class="btn btn-complete m-b-5 send-reactivate-link" data-url="{{ route('payment.entry.send.reactivate.link', [$row->uuid]) }}"  type="button" data-index="{{ $i }}"  type="button"> SEND REACTIVE LINK </button>
                                                @endif
